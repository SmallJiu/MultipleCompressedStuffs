package cat.jiu.multiple_compressed_blocks.example;
...
public class ExampleBaseBlock extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public ExampleBaseBlock(String name, Block unCompressedBlock, String langModID, CreativeTabs tab){
		super(name, unCompressedBlock, tab);
