...
public class BlockCompressedWool extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedWool(Block unCompressedBlock, String langModID) {
		super("compressed_wool_block", unCompressedBlock);
