...
public class BlockCompressedEmerald extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedEmerald(Block unCompressedBlock, String langModID) {
		super("compressed_emerald_block", unCompressedBlock);
