...
public class BlockCompressedStone extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedStone(Block unCompressedBlock, String langModID) {
		super("compressed_stone_block", unCompressedBlock);
