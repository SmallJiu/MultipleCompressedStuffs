...
public class BlockCompressedPumpkin extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedPumpkin(Block unCompressedBlock, String langModID) {
		super("compressed_pumpkin_block", unCompressedBlock);
