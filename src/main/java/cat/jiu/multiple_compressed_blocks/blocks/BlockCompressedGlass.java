...
public class BlockCompressedGlass extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedGlass(Block unCompressedBlock, String langModID) {
		super("compressed_glass_block", unCompressedBlock);
