...
public class BlockCompressedGlowStone extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedGlowStone(Block unCompressedBlock, String langModID) {
		super("compressed_glowstone_block", unCompressedBlock);
