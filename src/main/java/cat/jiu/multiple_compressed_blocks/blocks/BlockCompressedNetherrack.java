...
public class BlockCompressedNetherrack extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedNetherrack(Block unCompressedBlock, String langModID) {
		super("compressed_netherrack_block", unCompressedBlock);
