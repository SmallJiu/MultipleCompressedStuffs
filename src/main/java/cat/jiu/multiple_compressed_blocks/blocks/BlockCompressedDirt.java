...
public class BlockCompressedDirt extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedDirt(Block unCompressedBlock, String langModID) {
		super("compressed_dirt_block", unCompressedBlock);
