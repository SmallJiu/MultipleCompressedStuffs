...
public class BlockCompressedRedStone extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedRedStone(Block unCompressedBlock, String langModID) {
		super("compressed_redstone_block", unCompressedBlock);
