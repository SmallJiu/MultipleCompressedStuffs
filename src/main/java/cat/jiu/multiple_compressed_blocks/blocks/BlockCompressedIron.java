...
public class BlockCompressedIron extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedIron(Block unCompressedBlock, String langModID) {
		super("compressed_iron_block", unCompressedBlock);
