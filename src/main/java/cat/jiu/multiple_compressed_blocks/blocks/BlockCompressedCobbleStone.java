...
public class BlockCompressedCobbleStone extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedCobbleStone(Block unCompressedBlock, String langModID) {
		super("compressed_cobblestone_block", unCompressedBlock);
