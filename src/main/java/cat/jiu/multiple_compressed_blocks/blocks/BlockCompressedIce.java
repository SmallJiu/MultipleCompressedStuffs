...
public class BlockCompressedIce extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedIce(Block unCompressedBlock, String langModID) {
		super("compressed_ice_block", unCompressedBlock);
