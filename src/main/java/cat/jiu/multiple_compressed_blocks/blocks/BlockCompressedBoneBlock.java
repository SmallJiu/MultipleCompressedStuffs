...
public class BlockCompressedBoneBlock extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedBoneBlock(Block unCompressedBlock, String langModID) {
		super("compressed_bone_block", unCompressedBlock);
