...
public class BlockCompressedSand extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedSand(Block unCompressedBlock, String langModID) {
		super("compressed_sand_block", unCompressedBlock);
