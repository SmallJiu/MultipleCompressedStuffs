...
public class BlockCompressedMelonBlock extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedMelonBlock(Block unCompressedBlock, String langModID) {
		super("compressed_melon_block", unCompressedBlock);
