...
public class BlockCompressedSnow extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedSnow(Block unCompressedBlock, String langModID) {
		super("compressed_snow_block", unCompressedBlock);
