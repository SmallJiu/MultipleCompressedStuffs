...
public class BlockCompressedDiamond extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedDiamond(Block unCompressedBlock, String langModID) {
		super("compressed_diamond_block", unCompressedBlock);
