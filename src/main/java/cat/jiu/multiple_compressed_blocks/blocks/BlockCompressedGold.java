...
public class BlockCompressedGold extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedGold(Block unCompressedBlock, String langModID) {
		super("compressed_gold_block", unCompressedBlock);
