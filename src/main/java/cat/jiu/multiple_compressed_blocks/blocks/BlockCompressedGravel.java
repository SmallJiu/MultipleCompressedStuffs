...
public class BlockCompressedGravel extends BaseBlockSub implements IHasModel, IMetaName{
	...
	public BlockCompressedGravel(Block unCompressedBlock, String langModID) {
		super("compressed_gravel_block", unCompressedBlock);
