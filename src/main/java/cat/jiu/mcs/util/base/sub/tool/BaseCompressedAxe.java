...
public class BaseCompressedAxe extends BaseItemTool.MetaAxe implements ICompressedStuff, IToolRecipe {
	...
	public BaseCompressedAxe addCustemShiftInformation(List<TextComponentTranslation> infos) {
	...
	public BaseCompressedAxe addCustemShiftInformation(Map<Integer, List<TextComponentTranslation>> infos) {
	...
	public BaseCompressedAxe addCustemInformation(List<TextComponentTranslation> infos) {
		this.infos = infos;
		return this;
	}
	...
	public BaseCompressedAxe addCustemInformation(Map<Integer, List<TextComponentTranslation>> infos) {
	...
	public BaseCompressedAxe addInfoHandler(ITooltipString handler) {
	...
	public BaseCompressedAxe setCanShowBaseStackInfo(boolean canShow) {
