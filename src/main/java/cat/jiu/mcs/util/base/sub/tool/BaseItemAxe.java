...
public class BaseItemAxe extends BaseItemTool.MetaAxe implements ICompressedStuff {
	...
	public BaseItemAxe(ItemStack baseTool, String name) {
	...
	public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot, ItemStack stack) {
		...
		if(slot == EntityEquipmentSlot.MAINHAND) {
			...
			multimap.put(SharedMonsterAttributes.ATTACK_SPEED.getName(), new AttributeModifier(ATTACK_SPEED_MODIFIER, "Weapon modifier", this.baseAttackSpeed + ((stack.getMetadata()+1) * 0.0973), 0));
		}
		return multimap;
	}
	...
	public float getDestroySpeed(ItemStack stack, IBlockState state) {
		...
		speed += ((stack.getMetadata()+1)*speed) *1.3;// 60 is max speed
		return speed;
	}
	...
	public void getItemModel() {
		...
		this.model.registerItemModel(this, Short.MAX_VALUE, this.ownerMod + "/item/tools/axe/" + this.name, this.name + "." + Short.MAX_VALUE);
	}
