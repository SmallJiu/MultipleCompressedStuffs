...
public class BaseItemPickaxe extends BaseItemTool.MetaPickaxe implements ICompressedStuff {
	...
	public float getDestroySpeed(ItemStack stack, IBlockState state) {
		...
		speed += ((stack.getMetadata()+1)*speed) * 0.925;// 45 is max speed
		return speed;
	}
	...
	public int getHarvestLevel(ItemStack stack, String toolClass, EntityPlayer player, IBlockState blockState) {
		...
		level += ((stack.getMetadata()+1) * 0.339341);// 45 is max speed
		return level;
	}
	...
	public void getItemModel() {
		...
		this.model.registerItemModel(this, Short.MAX_VALUE, this.ownerMod + "/item/tools/pickaxe/" + this.name, this.name + "." + Short.MAX_VALUE);
	}
