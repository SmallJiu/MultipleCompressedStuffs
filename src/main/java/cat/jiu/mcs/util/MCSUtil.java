...
public class MCSUtil {
	...
	public static class ItemUtil {
		public double getMetaValue(double baseValue, int meta, float number) {
			return baseValue + (baseValue * ((meta+1) * number));
		}
			...
			if(Configs.use_3x3_recipes) {
				if(Configs.Tooltip_Information.show_specific_number) {
					if(!Configs.Tooltip_Information.can_custom_specific_number) {
						switch(meta) {
							case 0: tooltip.add("9 x " + name); break;
							case 1: tooltip.add("81 x " + name); break;
							case 2: tooltip.add("729 x " + name); break;
							case 3: tooltip.add("6,561 x " + name); break;
							case 4: tooltip.add("59,049 x " + name); break;
							case 5: tooltip.add("531,441 x " + name); break;
							case 6: tooltip.add("4,782,969 x " + name); break;
							case 7: tooltip.add("43,046,721 x " + name); break;
							case 8: tooltip.add("387,420,489 x " + name); break;
							case 9: tooltip.add("3,486,784,401 x " + name); break;
							case 10: tooltip.add("31,381,059,609 x " + name); break;
							case 11: tooltip.add("282,429,536,481 x " + name); break;
							case 12: tooltip.add("2,541,865,828,329 x " + name); break;
							case 13: tooltip.add("22,876,792,454,961 x " + name); break;
							case 14: tooltip.add("205,891,132,094,649 x " + name); break;
							case 15: tooltip.add("1,853,020,188,851,841 x " + name); break;
						}
					}else {
				...
				if(Configs.Tooltip_Information.show_specific_number) {
					if(!Configs.Tooltip_Information.can_custom_specific_number) {
						switch(meta) {
							case 0: tooltip.add("4 x " + name); break;
							case 1: tooltip.add("16 x " + name); break;
							case 2: tooltip.add("64 x " + name); break;
							case 3: tooltip.add("256 x " + name); break;
							case 4: tooltip.add("1,024 x " + name); break;
							case 5: tooltip.add("4,096 x " + name); break;
							case 6: tooltip.add("16,384 x " + name); break;
							case 7: tooltip.add("65,536 x " + name); break;
							case 8: tooltip.add("262,144 x " + name); break;
							case 9: tooltip.add("1,048,876 x " + name); break;
							case 10: tooltip.add("4,194,304 x " + name); break;
							case 11: tooltip.add("16,777,216 x " + name); break;
							case 12: tooltip.add("67,108,864 x " + name); break;
							case 13: tooltip.add("268,435,456 x " + name); break;
							case 14: tooltip.add("1,073,741,824 x " + name); break;
							case 15: tooltip.add("4,294,967,296 x " + name); break;
						}
					}else {
