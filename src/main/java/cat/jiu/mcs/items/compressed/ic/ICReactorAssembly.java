...
public class ICReactorAssembly extends BaseItemSub implements IReactorComponent, ICustomDamageItem {
	protected final IReactorComponent baseComponent;
	protected final ICustomDamageItem baseDamageItem;
	
	public ICReactorAssembly(String name, ItemStack baseItem) {
		super(name, baseItem);
		...
		if(baseItem.getItem() instanceof ICustomDamageItem) {
			...
			MCS.instance.log.error(baseItem.toString() + " is NOT ReactorAssembly");
		}
	}
	
	@Override
	public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag advanced) {
		if(this.unCompressedItem.getItem() != Item.getByNameOrId("ic2:iridium_reflector")
		|| this.unCompressedItem.getItem() != Item.getByNameOrId("ic2:component_heat_vent")) {
	...
	public int getCurrentHeat(ItemStack stack, IReactor reactor, int x, int y) {
		return this.getCustomDamage(this.unCompressedItem);
	}
